...
public class TileCache {
    ...
    public static ArrayList<ArrayList<ArrayList<String>>> getTile(Canvas c, int minx, int miny, ArrayList<String> predicates)
            throws Exception {
        ...
        for (int i = 0; i < c.getLayers().size(); i ++) {
            ...
            if (curLayer.isStatic())
                ...
                data.add(curLayer.getIndexer().getDataFromTile(c, i, minx, miny, predicates.get(i)));
        }
