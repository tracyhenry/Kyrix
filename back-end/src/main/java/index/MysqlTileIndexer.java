...
public class MysqlTileIndexer extends Indexer {
    ...
    public void createMV(Canvas c, int layerId) throws Exception {
        ...
        sql += "tuple_id int, cx double precision, cy double precision, minx double precision, " +
    ...
    public ArrayList<ArrayList<String>> getDataFromTile(Canvas c, int layerId, int minx, int miny, String predicate) throws Exception {
        ...
        String sql = "select " + colListStr + " from bbox_" + Main.getProject().getName() + "_"
                + c.getId() + "layer" + layerId + " bbox left join sorted_tile_"  + Main.getProject().getName() + "_"
