...
public class PsqlHierarchicalIndexer extends BoundingBoxIndexer {

    private static PsqlHierarchicalIndexer instance = null;
    private static boolean isCitus = false;

    // singleton pattern to ensure only one instance existed
    private PsqlHierarchicalIndexer(boolean isCitus) {
    ...
    public void createMV(Canvas c, int layerId) throws Exception {
        ...
        System.out.println("PsqlHierarchicalIndexer!!!!!!!!!!!!");
        ...
        for (int rowIndex = 0; rowIndex < hierarchy.size(); rowIndex++) {
