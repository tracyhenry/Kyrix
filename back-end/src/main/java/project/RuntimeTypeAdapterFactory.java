...
// /**
//  * Adapts values whose runtime type may differ from their declaration type. This is necessary
// when a
...
//  * }</pre>
//  *
//  * <p>Without additional type information, the serialized JSON is ambiguous. Is the bottom shape
// in
...
//  * }</pre>
//  *
//  * This class addresses this problem by adding type information to the serialized JSON and
// honoring
...
//  * {@link #of} factory method. If you don't supply an explicit type field name, {@code "type"}
// will
//  * be used.
//  *
//  * <pre>{@code
...
//  * your application from injection attacks. If you don't supply an explicit type label, the
// type's
...
//     /**
//      * Creates a new runtime type adapter using for {@code baseType} using {@code typeFieldName}
// as
//      * the type field name. Type field names are case sensitive. {@code maintainType} flag decide
// if
...
//     /**
//      * Registers {@code type} identified by its {@link Class#getSimpleName simple name}. Labels
// are
//      * case sensitive.
//      *
//      * @throws IllegalArgumentException if either {@code type} or its simple name have already
// been
//      *     registered on this type adapter.
//      */
